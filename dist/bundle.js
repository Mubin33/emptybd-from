(function () {
  ...
  ***************************************************************************** */
  ...
  var EmptyBDForm = function (_a) {
      ...
      var _d = reactExports.useState(null); _d[0]; _d[1];
      ...
      return (reactExports.createElement("div", { className: "max-w-xl mx-auto p-6 rounded-2xl shadow-lg bg-white", style: safeStyles.form },
          reactExports.createElement("h2", { className: "text-2xl font-semibold mb-4" }, "EmptyBDForm Form"),
          reactExports.createElement("form", { onSubmit: handleSubmit, className: "space-y-4" },
              reactExports.createElement("div", null,
                  reactExports.createElement("label", { className: "block text-sm font-medium", style: __assign({}, safeStyles.label) }, "Name"),
                  reactExports.createElement("input", { type: "text", name: "name", value: formData.name, onChange: handleChange, style: safeStyles.input.text, className: "w-full mt-1 p-2 border rounded-lg focus:outline-none focus:ring focus:ring-blue-300" })),
              reactExports.createElement("div", null,
                  reactExports.createElement("label", { className: "block text-sm font-medium", style: __assign({}, safeStyles.label) }, "Email"),
                  reactExports.createElement("input", { type: "email", name: "email", value: formData.email, onChange: handleChange, style: safeStyles.input.text, className: "w-full mt-1 p-2 border rounded-lg focus:outline-none focus:ring focus:ring-blue-300" })),
              reactExports.createElement("div", null,
                  reactExports.createElement("label", { className: "block text-sm font-medium", style: __assign({}, safeStyles.label) }, "Phone"),
                  reactExports.createElement("input", { type: "text", name: "phone", value: formData.phone, onChange: handleChange, style: safeStyles.input.text, className: "w-full mt-1 p-2 border rounded-lg focus:outline-none focus:ring focus:ring-blue-300" })),
              reactExports.createElement("div", null,
                  reactExports.createElement("label", { className: "block text-sm font-medium", style: __assign({}, safeStyles.label) }, "Message"),
                  reactExports.createElement("textarea", { name: "message", rows: 4, value: formData.message, onChange: handleChange, style: safeStyles.input.text, className: "w-full mt-1 p-2 border rounded-lg focus:outline-none focus:ring focus:ring-blue-300" })),
              reactExports.createElement("button", { type: "submit", style: safeStyles.button, className: "w-full py-2 rounded-xl transition" }, "Submit"))));
  };

  // bundle.tsx
  window.renderEmptyBDForm = function (selector, dataKey, styles) {
      var el = document.querySelector(selector);
      if (el) {
          var root = clientExports.createRoot(el);
          root.render(reactExports.createElement(EmptyBDForm, { dataKey: dataKey, styles: styles }));
      }
  };
